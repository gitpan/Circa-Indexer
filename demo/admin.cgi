...
# Drop table
if (param('drop')) {$indexor->drop_table_circa; print h1("Tables supprimées"); }
# Drop compte
if (param('dropSite')) { $indexor->drop_table_circa_id(param('id')); print h1("Comte supprimé"); }
# Create table
if (param('create')) {$indexor->create_table_circa; print h1("Tables créées"); }
# Add site
if (param('url'))
  {
